          ...
          {[
            {
              ...
              iconBg: "bg-primary/10",
              iconColor: "text-primary",
              title: t("dashboard.quickPortfolioTitle", "Portfólio"),
              desc: t("dashboard.quickPortfolioDesc", "Modelos cadastrados e faturamento"),
            },
            {
              ...
              iconBg: "bg-indigo-500/10",
              iconColor: "text-indigo-500",
              title: t("dashboard.quickCustomersTitle", "Clientes"),
              desc: t("dashboard.quickCustomersDesc", "CRM e base de compradores"),
            },
            {
              ...
              iconBg: "bg-success/10",
              iconColor: "text-success",
              title: t("dashboard.quickQuotationsTitle", "Cotações"),
              desc: t("dashboard.quickQuotationsDesc", "Orçamentos em PDF e WhatsApp"),
            },
            {
              ...
              title: t("dashboard.quickImportTitle", "Importar MakerWorld"),
              desc: t("dashboard.quickImportDesc", "Cole a URL e importe o modelo"),
            },
          ].map((item, i) => {
            const inner = (
