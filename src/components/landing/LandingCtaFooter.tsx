      ...
      <section className="py-24 relative overflow-hidden
        ...
        <div className="container mx-auto px-6 relative z-10 text-center">
          <h2 className="text-3xl md:text-5xl font-black text-white dark:text-foreground mb-8">
            {t('landing.ctaTitle', 'Pronto para imprimir seu primeiro projeto?')}
          </h2>
          <a
          ...
          >
            {t('landing.ctaButton', 'Começar Agora Gratuitamente')}
          </a>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-4 gap-12">
          <div className="col-span-2">
            ...
            <p className="text-muted-foreground max-w-sm leading-relaxed">
              {t('landing.footerTagline', 'Feito por makers, para makers. A plataforma completa para quem leva a impressão 3D a sério.')}
            </p>
          </div>
          <div>
            <h4 className="font-bold mb-4">{t('landing.footerPlatform', 'Plataforma')}</h4>
            <ul className="space-y-2 text-sm text-muted-foreground">
              <li><a href="#catalog" className="hover:text-primary">{t('landing.footerCatalog', 'Catálogo')}</a></li>
              <li><a href="#features" className="hover:text-primary">{t('landing.footerFeatures', 'Funcionalidades')}</a></li>
              <li><a href="/login" className="hover:text-primary">{t('landing.footerLogin', 'Entrar')}</a></li>
              <li><a href="/login?mode=signup" className="hover:text-primary">{t('landing.footerSignup', 'Cadastrar')}</a></li>
            </ul>
          </div>
          <div>
            <h4 className="font-bold mb-4">{t('landing.footerCommunity', 'Comunidade')}</h4>
            <ul className="space-y-2 text-sm text-muted-foreground">
              ...
              <li><a href="/dashboard/hub" className="hover:text-primary">{t('landing.footerHelpHub', 'Ajuda & Hub Maker')}</a></li>
            </ul>
          </div>
        </div>
        <div className="max-w-7xl mx-auto pt-12 mt-12 border-t border-border text-center">
          <p className="text-xs text-muted-foreground/60">
            © {new Date().getFullYear()} LB Creative Studio · {t('landing.footerMadeFor', 'Desenvolvido para Makers')}
          </p>
        </div>
      </footer>
    </>
